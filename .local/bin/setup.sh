...
main(){
    ...
    wget https://github.com/aristocratos/btop/releases/download/v1.4.1/btop-x86_64-linux-musl.tbz -v -O /tmp/btop-x86_64-linux-musl.tbz && mkdir -p /tmp/btop  && tar xvjf /tmp/btop-x86_64-linux-musl.tbz -C /tmp/btop/ && cd /tmp/btop/btop && sudo make  &&
